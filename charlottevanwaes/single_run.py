...
# parameters system
t_end, dt = 10, 1e-3 #minimal 1e-3 WCA potential
L = 100 #boxsize
N = 3
...
n_particles = 500 #amount of particles in system (including potentials)
...
file_name = 'Test'
frames_visualized = 80 #(higher saves time) =amount of timesteps (stored, see datasave param main code) between each frame
fps = 40 #frames per second
V.save_fig(trajectories[:,:,:N], trajectories[:,:,N].T, data, params, frames_visualized
           , fps, f'{file_name}', N = N, live = False, view = 'x', mode = mode)
