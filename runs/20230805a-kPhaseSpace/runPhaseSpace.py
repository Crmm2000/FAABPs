...
tSave = 200 # number of snapshots to save
...
#types of alignments
wAs  = np.tile(np.linspace(-1,1,11)/r0active,repeats)
r0passives = np.tile(np.linspace(1,12,12)*r0active,repeats) 

kTs = l2n([0.1]) #l2n([0.01,0.02,0.05,0.1,0.2,0.5])
